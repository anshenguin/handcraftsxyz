...
public class TestClassForLogOut extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_class_for_log_out);
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(TestClassForLogOut.this, LoginActivity.class);
