...
public class AppConfig {
    ...
    public static String URL_LOGIN = "http://handicraft-com.stackstaging.com/myapi/android_login_api/login.php";
    ...
    public  static  String URL_SUBSCRIPTION_LIST = "http://handicraft-com.stackstaging.com/myapi/android_login_api/subscribed_list.php";
